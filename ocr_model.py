...
# Path to the data directory
data_dir = Path(r"C:\Users\kira\Desktop\code\new_captcha\captcha_images_v2\captcha_images_v2")

# Check if directory and files exist
if not data_dir.exists():
    raise ValueError("Error: Directory does not exist.")
if not any(data_dir.glob("*.png")):
    raise ValueError("Error: No PNG files found in the directory.")
...
if not images or not labels:
    raise ValueError("No images or labels found. Please check the data directory and file extensions.")
...
for batch in validation_dataset.take(1):
    ...
    for i in range(len(pred_texts)):
        ...
        ax[i // 4, i % 4].axis("off")
model.save("ocr_captcha_model.keras")
plt.show()